...
<head>
    ...
    <style>
        ...
        h1 { margin-bottom: 2rem; border-bottom: 1px solid #e2e8f0; padding-bottom: 1rem; font-size: 1.5rem; color: #0f172a; }
...
# HTML ORIGINAL, SOLO SE AGREGÓ EL CÓDIGO DE PAGINACIÓN AL FINAL
HTML_GALLERY = """
<!DOCTYPE html>
<html lang="es">
<head>
...
def index():
    try:
        ...
        # Invertimos la lista en Python para que los nuevos salgan primero
        all_videos.reverse()
